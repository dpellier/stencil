import { BuildCtx, CompilerCtx, ComponentRegistry, Config } from '../../declarations';
...
export async function generateAppFiles(config: Config, compilerCtx: CompilerCtx, buildCtx: BuildCtx, cmpRegistry: ComponentRegistry) {
