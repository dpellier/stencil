import { ComponentData, ComponentMeta, Config, Manifest, ManifestData, ModuleFile } from '../../../declarations';
...
describe('manifest-data serialize/parse', () => {
  ...
  it('serializeAppManifest', () => {
    ...
    const outManifest = serializeAppManifest(config, manifestDir, manifest.modulesFiles, manifest.global);
